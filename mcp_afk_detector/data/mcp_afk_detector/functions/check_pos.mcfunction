...
advancement grant @s[scores={mcp_afk_total=86400}] only mcp:get_back_to_work

execute as @s[scores={mcp_afk_count=900..},tag=!mcp_afk] run function mcp_afk_detector:afk_away
