...
#1.15 Version differences
#   Removed selected from kick hover event in 'enter_bed.mcfunction'
#   Changed Dimensions selector to numerical value '0' in 'player_count.mcfunction'