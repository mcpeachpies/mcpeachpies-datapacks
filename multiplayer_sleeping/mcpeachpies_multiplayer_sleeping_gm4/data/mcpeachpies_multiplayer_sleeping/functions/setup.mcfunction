...
#Gamemode 4 Changes
#   Removed mcpeachpies:root advancement
#   Linked 'the_courtesy_call' advancement to gm4:root
#   Advancements are translatable
#   Set clock.mcfunction schedule to 16t
#   this file is run from #load:mcpeachpies_multiplayer_sleeping
